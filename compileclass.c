void Compileclass (TString myopt="fast"){
  ...
  gSystem->CompileMacro("./macros/simulation1.cxx", opt.Data()); 
  gSystem->CompileMacro ("./macros/reconstruction1.cxx", opt.Data()); 
  gSystem->CompileMacro ("./macros/plot.cxx", opt.Data());
}
